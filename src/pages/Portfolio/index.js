...
const Portfolio = () => {
  ...
  const [WebCards, setWebCards] = useState(
    ...
    [{ Name: "Fact-Ori", Description: "Fact-ori is a community fact sharing site that allows users to post and share interesting facts. The site has a range of functionality for users, including posting anonymous fact entries, add gifs from giphy in an entry using the giphy API, view other peoples' entries, react to other peoples’ entries with an emoji & comment on other people’s entries.", gifurl: "https://s6.gifyu.com/images/ezgif-2-1e3493f6f1dc.gif", repoLink: "https://github.com/Shavvimal/Fact-Ori", siteLink: "https://fact-ory.netlify.app/", arrayOfWords: ["HTML", "JavaScript", "Tailwind CSS", "Node.js", "Express", "Docker"], graphic:false },
    { Name: "The Treasury", Description: "The Treasury allows users to track their investment portfolio, with their chosen stocks, monitoring the individual price changes, returning their profit/loss on their investments, trace the movement of their individual holdings and get a general idea of how their portfolio is doing. It uses Authentication and Authorization and a login page. ", gifurl: "https://s6.gifyu.com/images/ezgif-2-f31a7e2a6834.gif", repoLink: "https://github.com/Shavvimal/Galic-NaN", siteLink: "https://the-treasury.netlify.app/", arrayOfWords: ["Bcrypt", "JWT", "JavaScript", "Express", "Node.js", "Docker", "SQL", "AWS", "Tailwind CSS", "Greensock"], graphic:false },
    { Name: "Anonymous Blog site", Description: "This site was a 23-hour code challenge practice clone of telegra.ph, with a minimalistic front-end. PostgreSQL is used in cojunction with a database API served on an AWS EC2 instance as a backend to store posts. The site allows users simply to post anonymously, and using AWS circumvents the issue of alternatives like Heroku going to sleep.", gifurl: "https://s6.gifyu.com/images/ezgif-3-9a21da11874e.md.gif", repoLink: "https://github.com/Shavvimal/LAP_2_Code_Challenge_Parent", siteLink: "https://anon-blog.netlify.app/", arrayOfWords: ["Amazon", "AWS", "PostgreSQL", "Node.js", "Express", "Docker"], graphic:false }]
