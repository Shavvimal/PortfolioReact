...
const Portfolio = () => {
  ...
  const [GraphicsCards, setGraphicsCards] = useState(
    ...
    [{ Name: "Galaxy Girl", Description: "This was my first ever digital painting using a graphics tablet. This was a really fun piece to make while learning all the basics of working in a new and different medium. ", gifurl: "./gifs/1.gif", repoLink: "https://www.deviantart.com/shavgraphics/art/Galaxy-Girl-847582040", siteLink: "https://youtu.be/jUyj_YXad_k", arrayOfWords: ["Adobe PhotoShop"], graphic:true },
    { Name: "Zuko on the Beach", Description: "After rewatching one of my favorite shows of all time, Avatar: The Last Airbender, I decided to do a fanart of my favorite scarred Prince - Prince Zuko.", gifurl: "./gifs/1.gif", repoLink: "https://www.deviantart.com/shavgraphics/art/Zuko-868343159", siteLink: "https://youtu.be/2audU-MHQ3Q", arrayOfWords: ["Adobe PhotoShop"], graphic:true },
    ]
