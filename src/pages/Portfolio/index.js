...
const Portfolio = () => {
  ...
  const [WebCards, setWebCards] = useState(
    ...
    [{ Name: "Fact-Ori", Description: "Fact-ori is a community fact sharing site that allows users to post and share interesting facts. The site has a range of functionality for users, including posting anonymous fact entries, add gifs from giphy in an entry using the giphy API, view other peoples' entries, react to other peoples’ entries with an emoji & comment on other people’s entries.", gifurl: "https://raw.githubusercontent.com/Shavvimal/gifstore/main/gifs/ezgif-2-1e3493f6f1dc.gif", repoLink: "https://github.com/Shavvimal/Fact-Ori", siteLink: "https://fact-ory.netlify.app/", arrayOfWords: ["HTML", "JavaScript", "Tailwind CSS", "Node.js", "Express", "Docker"], graphic:false },
    { Name: "The Treasury", Description: "The Treasury allows users to track their investment portfolio, with their chosen stocks, monitoring the individual price changes, returning their profit/loss on their investments, trace the movement of their individual holdings and get a general idea of how their portfolio is doing. It uses Authentication and Authorization and a login page. ", gifurl: "https://raw.githubusercontent.com/Shavvimal/gifstore/main/gifs/ezgif-2-f31a7e2a6834.gif", repoLink: "https://github.com/Shavvimal/Galic-NaN", siteLink: "https://the-treasury.netlify.app/", arrayOfWords: ["Bcrypt", "JWT", "JavaScript", "Express", "Node.js", "Docker", "SQL", "AWS", "Tailwind CSS", "Greensock"], graphic:false },
    { Name: "Anonymous Blog site", Description: "This site was a 23-hour code challenge practice clone of telegra.ph, with a minimalistic front-end. PostgreSQL is used in cojunction with a database API served on an AWS EC2 instance as a backend to store posts. The site allows users simply to post anonymously, and using AWS circumvents the issue of alternatives like Heroku going to sleep.", gifurl: "https://raw.githubusercontent.com/Shavvimal/gifstore/main/gifs/ezgif-3-9a21da11874e.gif", repoLink: "https://github.com/Shavvimal/LAP_2_Code_Challenge_Parent", siteLink: "https://anon-blog.netlify.app/", arrayOfWords: ["Amazon", "AWS", "PostgreSQL", "Node.js", "Express", "Docker"], graphic:false }]
  ...
  const [GraphicsCards, setGraphicsCards] = useState(
    ...
    [{ Name: "Galaxy Girl", Description: "This was my first ever digital painting using a graphics tablet. This was a really fun piece to make while learning all the basics of working in a new and different medium. ", gifurl: "https://raw.githubusercontent.com/Shavvimal/gifstore/main/gifs/ezgif-3-4c490125b490.gif", repoLink: "https://www.deviantart.com/shavgraphics/art/Galaxy-Girl-847582040", siteLink: "https://youtu.be/jUyj_YXad_k", arrayOfWords: ["Adobe PhotoShop"], graphic:true },
    { Name: "Zuko on the Beach", Description: "After rewatching one of my favorite shows of all time, Avatar: The Last Airbender, I decided to do a fanart of my favorite scarred Prince - Prince Zuko.", gifurl: "https://raw.githubusercontent.com/Shavvimal/gifstore/main/gifs/ezgif-3-b5a5dbe3b50c.gif", repoLink: "https://www.deviantart.com/shavgraphics/art/Zuko-868343159", siteLink: "https://youtu.be/2audU-MHQ3Q", arrayOfWords: ["Adobe PhotoShop"], graphic:true },
    ]
